...
// [GUID] --> DXGI
const GUID WicIO::guid_to_dxgi_SOURCE[CLS_COMMONT_IMAGE_WICMETA__NUM_GUID_DXGI] = {
    // 64 BPP
...
// GUID --> [DXGI]
const DXGI_FORMAT WicIO::guid_to_dxgi_TARGET[CLS_COMMONT_IMAGE_WICMETA__NUM_GUID_DXGI] = {
    // 64 BPP
...
// [GUID] --> GUID
const GUID WicIO::guid_to_guid_SOURCE[CLS_COMMONT_IMAGE_WICMETA__NUM_GUID_GUID] = {
    // 24 BPP
    GUID_WICPixelFormat24bppBGR,
};
// GUID --> [GUID]
const GUID WicIO::guid_to_guid_TARGET[CLS_COMMONT_IMAGE_WICMETA__NUM_GUID_GUID] = {
    // 32 BPP
    GUID_WICPixelFormat32bppBGR,
};

bool WicIO::open(LPCWSTR path, WIC_META& refMeta) noexcept {
    // Open file
...
bool WicIO::open(void* data, UINT64 size, WIC_META& refMeta) noexcept {
    // Load from memory
...
void WicIO::close(WIC_META& refMeta) noexcept {
    // Check file close
...
bool WicIO::open(IWICImagingFactory* ptrFactory, IWICBitmapDecoder* ptrDecoder, WIC_META& refMeta) noexcept {
...
bool WicIO::convert_GUID_to_DXGI(GUID inputGuid, DXGI_FORMAT* ptrFormat) noexcept {
    // Find matching GUID
...
bool WicIO::convert_GUID_to_GUID(GUID inputGuid, GUID* ptrGuid) noexcept {
    // Find matching GUID
